 ...
 * 你可以通过startService(Intent)来提交请求，该Service会在需要的时候创建，当完成所有的任务以后自己关闭，且请求是在工作线程处理的。
...
public class UploadImgService extends IntentService {
    ...
    public static final String UPLOAD_RESULT = "com.android.intentservice.action.UPLOAD_RESULT";
